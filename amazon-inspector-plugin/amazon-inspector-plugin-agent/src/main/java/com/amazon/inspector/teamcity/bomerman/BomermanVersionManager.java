...
public class BomermanVersionManager {
    ...
    private static final List<String> AMD64_ARCH_NAMES = List.of("x86_64", "amd64");
    private static final List<String> ARM64_ARCH_NAMES = List.of("aarch64");
    ...
    public static String getBomermanName(String osName, String archName) throws BomermanNotFoundException {
        ...
        if (osName.contains(LINUX_NAME)) {
            if (AMD64_ARCH_NAMES.contains(archName)) {
